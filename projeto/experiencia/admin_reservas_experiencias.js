function carregarReservasExperiencias() {
    fetch("listar_reservas_experiencias.php")
        .then(r => r.json())
        .then(lista => {
            let html = "";
            ...
            lista.forEach(r => {
                html += `
                    <tr>
                        ...
                        <td>
                            <a href="editar_reserva_experiencia.php?id=${r.id}" class="btn btn-warning btn-sm">Editar</a>
...
function excluir(id) {
    ...
    fetch("excluir_reserva_experiencia.php?id=" + id)
        .then(r => r.text())
        .then(msg => {
            alert(msg);
            carregarReservasExperiencias();
